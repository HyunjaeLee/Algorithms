...
data:
  ...
  bundledCode: "#line 1 \"test/mo/hilbert_mo_range_kth_smallest.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/range_kth_smallest\"\n\n#line 1 \"\
    mo/hilbert_mo.hpp\"\n\n\n\n#include <algorithm>\n#include <array>\n#include <cassert>\n\
    ...
    \ }\n        return cnt;\n    }\n\nprivate:\n    const int m_, b_sz_;\n    std::vector<int>\
    \ freq_, bucket_;\n    int total_ = 0, distinct_ = 0;\n};\n\n\n#line 5 \"test/mo/hilbert_mo_range_kth_smallest.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/mo/hilbert_mo_range_kth_smallest.test.cpp
- /verify/test/mo/hilbert_mo_range_kth_smallest.test.cpp.html
