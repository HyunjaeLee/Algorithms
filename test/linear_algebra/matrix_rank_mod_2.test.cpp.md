...
data:
  ...
  bundledCode: "#line 1 \"test/linear_algebra/matrix_rank_mod_2.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/matrix_rank_mod_2\"\n\n#line 1 \"\
    linear_algebra/gf2_matrix.hpp\"\n\n\n\n#include <bit>\n#include <string_view>\n\
    #include <vector>\n\n#ifdef __x86_64__\n#define USE_AVX2\n#endif\n\n#ifdef USE_AVX2\n\
    #include <immintrin.h>\n#endif\n\nstruct GF2Matrix {\n    GF2Matrix(int r, int\
    \ c) : rows_(r), cols_(c), stride_((c + 63) / 64) {\n        data_ = new unsigned\
    \ long long[rows_ * stride_]{};\n    }\n    ~GF2Matrix() { delete[] data_; }\n\
    \    void set(int r, int c) { data_[r * stride_ + (c / 64)] |= (1ULL << (c % 64));\
    \ }\n    void flip(int r, int c) { data_[r * stride_ + (c / 64)] ^= (1ULL << (c\
    \ % 64)); }\n    bool get(int r, int c) { return (data_[r * stride_ + (c / 64)]\
    \ >> (c % 64)) & 1; }\n#ifdef USE_AVX2\n    __attribute__((target(\"avx2\")))\
    \ void xor_rows(unsigned long long *d,\n                                     \
    \             const unsigned long long *s, int start_idx) {\n        int i = start_idx;\n\
    \        for (; i + 4 <= stride_; i += 4) {\n            auto dst = reinterpret_cast<__m256i\
    ...
    \    unsigned long long *data_;\n};\n\n\n#line 4 \"test/linear_algebra/matrix_rank_mod_2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/linear_algebra/matrix_rank_mod_2.test.cpp
layout: document
redirect_from:
- /verify/test/linear_algebra/matrix_rank_mod_2.test.cpp
- /verify/test/linear_algebra/matrix_rank_mod_2.test.cpp.html
