...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/2270
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/2270
  bundledCode: "#line 1 \"test/mo/aoj2270.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2270\"\
    ...
    \ i) { ans[i] = C[table.kth(K[i])]; };\n    mo.solve(add, remove, eval);\n   \
    \ std::ranges::copy(ans, std::ostream_iterator<int>(std::cout, \"\\n\"));\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2270\"\n\n#include\
  ...
  verifiedWith: []
documentation_of: test/mo/aoj2270.test.cpp
layout: document
redirect_from:
- /verify/test/mo/aoj2270.test.cpp
- /verify/test/mo/aoj2270.test.cpp.html
