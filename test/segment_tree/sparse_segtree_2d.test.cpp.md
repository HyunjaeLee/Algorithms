...
data:
  ...
  bundledCode: "#line 1 \"test/segment_tree/sparse_segtree_2d.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_rectangle_sum\"\n\n#line\
    \ 1 \"segment_tree/sparse_segtree_2d.hpp\"\n\n\n\n#include <algorithm>\n#include\
    ...
    };\n\n\n#line 4 \"test/segment_tree/sparse_segtree_2d.test.cpp\"\n#include <bits/stdc++.h>\n\
    ...
    \   auto e = [] { return 0LL; };\n    sparse_segtree_2d<int, long long, op, e>\
    \ seg(int(points.size()),\n                                                 [&](int\
  ...
  verifiedWith: []
documentation_of: test/segment_tree/sparse_segtree_2d.test.cpp
layout: document
redirect_from:
- /verify/test/segment_tree/sparse_segtree_2d.test.cpp
- /verify/test/segment_tree/sparse_segtree_2d.test.cpp.html
