...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/2963
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/2963
  bundledCode: "#line 1 \"test/optimization/aizu2963.test.cpp\"\n#define PROBLEM \"\
    ...
    \        }\n    }\n    return ans;\n}\n\n\n#line 4 \"test/optimization/aizu2963.test.cpp\"\
    \n#include <bits/stdc++.h>\n\nint main() {\n    std::cin.tie(0)->sync_with_stdio(0);\n\
    \    long long A, B;\n    std::cin >> A >> B;\n    auto [canonical, w, mw] = greedy_optimality(std::vector{1LL,\
    \ A, B});\n    std::cout << w << \"\\n\";\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2963\"\n\n#include\
  ...
  verifiedWith: []
documentation_of: test/optimization/aizu2963.test.cpp
layout: document
redirect_from:
- /verify/test/optimization/aizu2963.test.cpp
- /verify/test/optimization/aizu2963.test.cpp.html
