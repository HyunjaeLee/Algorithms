...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"link_cut_tree/lazy_link_cut_tree.hpp\"\n\n\n\n#include <cassert>\n\
    #include <type_traits>\n#include <utility>\n#include <vector>\n\ntemplate <typename\
...
documentation_of: link_cut_tree/lazy_link_cut_tree.hpp
layout: document
redirect_from:
- /library/link_cut_tree/lazy_link_cut_tree.hpp
- /library/link_cut_tree/lazy_link_cut_tree.hpp.html
